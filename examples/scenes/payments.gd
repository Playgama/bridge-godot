...
func _on_purchase_button_pressed():
	Bridge.payments.purchase("test_product", null, funcref(self, "_on_purchase_completed"))
...
func _on_consume_button_pressed():
	Bridge.payments.consume_purchase("test_product", funcref(self, "_on_consume_completed"))
