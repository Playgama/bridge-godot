...
var _js_get_tasks_then = JavaScript.create_callback(self, "_on_js_get_tasks_then")
var _js_get_tasks_catch = JavaScript.create_callback(self, "_on_js_get_tasks_catch")

var _add_progress_callback = null
var _js_add_progress_then = JavaScript.create_callback(self, "_on_js_add_progress_then")
var _js_add_progress_catch = JavaScript.create_callback(self, "_on_js_add_progress_catch")

var _claim_reward_callback = null
var _js_claim_reward_then = JavaScript.create_callback(self, "_on_js_claim_reward_then")
var _js_claim_reward_catch = JavaScript.create_callback(self, "_on_js_claim_reward_catch")
...
func get_tasks(callback = null):
	...
	_js_tasks.getTasks() \
		.then(_js_get_tasks_then) \
		.catch(_js_get_tasks_catch)
...
func add_progress(metric, amount = 1, callback = null):
	...
	_js_tasks.addProgress(metric, amount) \
		.then(_js_add_progress_then) \
		.catch(_js_add_progress_catch)
...
func claim_reward(task_id, callback = null):
	...
	_js_tasks.claimReward(task_id) \
		.then(_js_claim_reward_then) \
		.catch(_js_claim_reward_catch)


func _on_js_get_tasks_then(args):
	if _get_tasks_callback != null:
		_get_tasks_callback.call_func(true, _js_to_gd(args[0]))
		_get_tasks_callback = null

func _on_js_get_tasks_catch(args):
	if _get_tasks_callback != null:
		_get_tasks_callback.call_func(false, [])
		_get_tasks_callback = null

func _on_js_add_progress_then(args):
	if _add_progress_callback != null:
		_add_progress_callback.call_func(true)
		_add_progress_callback = null

func _on_js_add_progress_catch(args):
	if _add_progress_callback != null:
		_add_progress_callback.call_func(false)
		_add_progress_callback = null

func _on_js_claim_reward_then(args):
	if _claim_reward_callback != null:
		# args[0] is a boolean: whether the claim succeeded
		_claim_reward_callback.call_func(args[0] == true)
		_claim_reward_callback = null

func _on_js_claim_reward_catch(args):
	if _claim_reward_callback != null:
		_claim_reward_callback.call_func(false)
		_claim_reward_callback = null
