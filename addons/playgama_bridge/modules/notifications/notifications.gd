...
var _js_schedule_then = JavaScript.create_callback(self, "_on_js_schedule_then")
var _js_schedule_catch = JavaScript.create_callback(self, "_on_js_schedule_catch")
var _cancel_callback = null
var _js_cancel_then = JavaScript.create_callback(self, "_on_js_cancel_then")
var _js_cancel_catch = JavaScript.create_callback(self, "_on_js_cancel_catch")
var _cancel_all_callback = null
var _js_cancel_all_then = JavaScript.create_callback(self, "_on_js_cancel_all_then")
var _js_cancel_all_catch = JavaScript.create_callback(self, "_on_js_cancel_all_catch")
...
func schedule(notification, callback = null):
	...
	_js_notifications.schedule(js_notification) \
		.then(_js_schedule_then) \
		.catch(_js_schedule_catch)
...
func cancel(id, callback = null):
	...
	_js_notifications.cancel(id) \
		.then(_js_cancel_then) \
		.catch(_js_cancel_catch)
...
func cancel_all(callback = null):
	...
	_js_notifications.cancelAll() \
		.then(_js_cancel_all_then) \
		.catch(_js_cancel_all_catch)
